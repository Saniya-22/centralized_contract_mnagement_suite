...
def test_search_regulations_execution(
    mock_hybrid_search, mock_get_embedding, mock_rerank
):
    ...
    # Execute search
    result = VectorSearchTool.search_regulations.invoke({"query": "test query", "k": 5})
